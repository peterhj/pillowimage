...
fn main() {
  ...
  bindgen::Builder::default()
    ...
    //.whitelist_type("GIFDECODERSTATE_T")
    //.whitelist_type("JPEGSTATE_T")
    //.whitelist_type("ZIPSTATE_T")
    ...
    //.whitelist_var("IMAGING_CODEC_END")
    //.whitelist_var("IMAGING_CODEC_OVERRUN")
    //.whitelist_var("IMAGING_CODEC_BROKEN")
    //.whitelist_var("IMAGING_CODEC_UNKNOWN")
    //.whitelist_var("IMAGING_CODEC_CONFIG")
    //.whitelist_var("IMAGING_CODEC_MEMORY")
